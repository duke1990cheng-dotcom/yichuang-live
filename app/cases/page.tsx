...
const cases = [
  ["西晒客厅隔热方案", "针对客厅下午西晒、玻璃附近热感明显的问题，优先考虑低反光住宅隔热膜，兼顾采光和舒适度。"],
  ["落地窗隐私方案", "针对大面积落地窗、楼间距较近或临街视线问题，配置白天隐私膜并建议夜间配合窗帘。"],
  ["阳光房隔热方案", "针对阳光房夏季闷热、强光和家具暴晒问题，结合顶面与侧面玻璃情况选择隔热方案。"]
];
    ...
    <>
      ...
      <section className="container-page grid gap-5 py-14 md:grid-cols-3">
        {cases.map(([title, text]) => (
          <Card key={title}>
            <div className="mb-5 aspect-[4/3] rounded-md bg-gradient-to-br from-blue/18 via-white to-sage/16" />
